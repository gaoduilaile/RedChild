...
public class SweetSheet {
    ...
    private OnbacgroundListener mOnbacgroundListener;
    ...
    private void setup() {
        if (mOnbacgroundListener != null) {
            mDelegate.setOnbacgroundClickListener(mOnbacgroundListener);
        }
    ...
    public void setOnbacgroundClickListener(OnbacgroundListener onbacgroundListener) {
        if (mDelegate != null) {
            mDelegate.setOnbacgroundClickListener(onbacgroundListener);
        } else {
            mOnbacgroundListener = onbacgroundListener;
        }
    }
    ...
    public interface OnbacgroundListener {
        boolean onBackgroundClick();
        void onBackgroundShow();
        void onBackgroundDismiss();
    }
