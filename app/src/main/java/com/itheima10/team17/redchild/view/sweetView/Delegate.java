...
public abstract class Delegate implements View.OnClickListener {
    ...
    protected SweetSheet.OnbacgroundListener mOnBackgroundClickListener;
    ...
    protected void show() {
        ...
        if (mOnBackgroundClickListener != null) {
            mOnBackgroundClickListener.onBackgroundShow();
        }
    }
    ...
    protected void dismiss() {
        ...
        dismissShowdown();
        if (mOnBackgroundClickListener != null) {
            mOnBackgroundClickListener.onBackgroundDismiss();
        }
    ...
    protected void setOnbacgroundClickListener(SweetSheet.OnbacgroundListener onbacgroundListener) {
        mOnBackgroundClickListener = onbacgroundListener;
    }
