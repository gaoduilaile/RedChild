...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = DrawUtil.dp2Px(5);
    private static final float Y = DrawUtil.dp2Px(20);
    private static final float V = DrawUtil.dp2Px(2);
    private static final float W = DrawUtil.dp2Px(1);
